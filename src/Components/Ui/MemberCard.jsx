export default function MemberCard({Card}) {
    ...
    return   <div className="CreatedGroupQ border-1 rounded-sm  h-110 w-300 mt-10 flex items-center justify-around "  >
           
    {
        Card.map((ele , idx)=>{
            return <div key={ele.id} className="border-1 h-80 w-60 rounded-lg shadow-2xl p-5">
